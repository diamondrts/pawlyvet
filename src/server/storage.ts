...
import collar from "@/components/img/collar.jpg";
...
export const staticData = {
  ...
  products: [
    ...
    { id: 3, name: "Collar Ajustable", description: "Estilo y seguridad en los paseos.", category: "accessories", imageUrl: collar },
    { id: 4, name: "Cama Ortopédica", description: "El descanso que ellos merecen.", category: "beds", imageUrl: cama },
  ],
  testimonials: [
