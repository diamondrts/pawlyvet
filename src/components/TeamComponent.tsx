        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1 relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4 pt-12">
                  ...
                  <div className="bg-pink-500 p-6 rounded-3xl text-white text-center shadow-lg">
                ...
                <div className="space-y-4">
                  <img
                    src={img3}
                    alt="Dog"
                    className="rounded-3xl shadow-lg w-full h-70 object-cover"
                  />
                  <img
                    src={img9}
                    alt="Team"
            ...
            <div className="order-1 md:order-2 space-y-8 ">
              <div className="inline-block px-4 py-1.5 rounded-full bg-pink-100 text-pink-500 font-bold text-sm uppercase tracking-wide">
                Sobre Nosotros
              </div>
              <h2 className="text-4xl font-display font-bold leading-tight text-stone-600">
                Más que veterinarios, somos amantes de los animales
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed text-stone-400">
        ...
        <div className="grid justify-center pt-16">
                <div className="flex flex-col md:flex-row items-center gap-4 mb-6">
                  ...
                  //  {staticData.team?.slice(0, 4).map((member, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 bg-white p-2 pr-4 rounded-full shadow-sm border border-white/50"
                    >
                      <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center overflow-hidden text-pink-500">
                        {member.imageUrl ? (
                          <img
                            src={member.imageUrl}
                            alt={member.name}
                      ...
                      <div className="text-sm">
                        <p className="font-bold leading-none capitalize text-stone-600">{member.name}</p>
                        <p className="text-xs text-muted-foreground capitalize text-stone-400">
                          {member.role}
                        </p>
                      </div>
                    </div>
