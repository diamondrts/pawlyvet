...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background font-[Nunito] selection:bg-primary/20">
      <Navigation />

      {/* HERO SECTION */}
      <section
        id="home"
        className="relative pt-25 pb-20 lg:pt-32 lg:pb-32 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left space-y-8">
              <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm  mb-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <Heart className="text-pink-500 w-4 h-4 fill-pink-500" />
                <span className="text-sm font-semibold text-[#3D2833] tracking-wide uppercase">
                  Amor incondicional
                </span>
              </div>
      ...
      <section
        id="hotel"
        className="py-24 bg-pink-500 text-white relative overflow-hidden"
      >
            ...
            <div className="md:w-1/2 space-y-8">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {benefits.map((benefit, i) => (
                  <li
                    key={i}
                    className="flex items-center gap-3 bg-white/30 p-3 rounded-xl backdrop-blur-sm"
                  >
                    <div className="bg-white text-pink-500  p-1 rounded-full">
                      <PawPrint size={14} />
                    </div>
